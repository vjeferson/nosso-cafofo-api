...
routes.get('/estatisticas/planos-assinados-por-estado', authMiddleware, authAdministradorNossoCafofoMiddleware, estatisticasController.planosAssinadosPorEstado);
